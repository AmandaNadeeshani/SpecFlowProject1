...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("working with the tables")]
        [NUnit.Framework.CategoryAttribute("testerstalk")]
        public virtual void WorkingWithTheTables()
        {
            string[] tagsOfScenario = new string[] {
                    "testerstalk"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("working with the tables", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 17
 this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
            ...
            else
            {
                ...
                table1.AddRow(new string[] {
                            "70"});
#line 18
 testRunner.Given("I input the followin numbers to the calculator", ((string)(null)), table1, "Given ");
#line hidden
#line 22
